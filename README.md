...
| poetry-lint-ansible            | poetry environment | A custom [script](src/pre-commit/lint-ansible.sh) and the local [poetry](https://python-poetry.org/) environment are used to invoke this tool.                                                                               |
