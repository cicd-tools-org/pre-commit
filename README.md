...
| lint-github-workflow-header    | CICD-Tools         | A custom [script](src/pre-commit/lint-github-workflow-header.sh) is invoked.                                                                                                                                                 |
...
| spelling-vale-vocab            | local binary       | The local shell binary is used to invoke a one-liner using [sort](https://www.gnu.org/software/coreutils/manual/html_node/sort-invocation.html).                                                                             |
| poetry-lint-ansible            | poetry environment | A custom [script](src/pre-commit/lint-ansible.sh) and the project's [poetry](https://python-poetry.org/) environment are used to invoke this tool.                                                                           |
