...
| gettext-translations-add     | CICD-Tools         | The [CICD-Tools gettext container](https://github.com/cicd-tools-org/cicd-tools/blob/main/.cicd-tools/container/gettext/Dockerfile) is used to invoke this tool.                                                                        |
| gettext-translations-compile | CICD-Tools         | The [CICD-Tools gettext container](https://github.com/cicd-tools-org/cicd-tools/blob/main/.cicd-tools/container/gettext/Dockerfile) is used to invoke this tool.                                                                        |
| gettext-translations-missing | CICD-Tools         | The [CICD-Tools gettext container](https://github.com/cicd-tools-org/cicd-tools/blob/main/.cicd-tools/container/gettext/Dockerfile) is used to invoke this tool.                                                                        |
| gettext-translations-update  | CICD-Tools         | The [CICD-Tools gettext container](https://github.com/cicd-tools-org/cicd-tools/blob/main/.cicd-tools/container/gettext/Dockerfile) is used to invoke this tool.                                                                        |
...
| spelling-commit-message      | CICD-Tools         | The [CICD-Tools utilities container](https://github.com/cicd-tools-org/cicd-tools/blob/main/.cicd-tools/container/utilities/Dockerfile) is used to invoke this tool.                                                                    |
