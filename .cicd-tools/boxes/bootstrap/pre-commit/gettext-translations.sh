...
_gettext_translations_generate_or_update_pot_file() {
  ...
  while IFS= read -r -d $'\0' GETTEXT_TRANSLATIONS_SOURCE_FILE; do
    ...
    find \
      ...
      -ipath "${GETTEXT_TRANSLATIONS_CODE_BASE_REGEX}" \
      -print0
  )
...
gettext_translations_update() {
  ...
  local GETTEXT_TRANSLATIONS_LANGUAGES
  local GETTEXT_TRANSLATIONS_LANGUAGE_PO_FILE
  local GETTEXT_TRANSLATIONS_LANGUAGE_POT_FILE
  local GETTEXT_TRANSLATIONS_LANGUAGE_SUB_PATH
  ...
  for GETTEXT_TRANSLATIONS_LANGUAGE in "${GETTEXT_TRANSLATIONS_LANGUAGES[@]}"; do
    ...
    log "INFO" "  Updating '${GETTEXT_TRANSLATIONS_LANGUAGE}' ..."
    GETTEXT_TRANSLATIONS_LANGUAGE_SUB_PATH="${GETTEXT_TRANSLATIONS_BASE_PATH}/${GETTEXT_TRANSLATIONS_LANGUAGE}/LC_MESSAGES"

    for GETTEXT_TRANSLATIONS_LANGUAGE_POT_FILE in "${GETTEXT_TRANSLATIONS_BASE_PATH}/"*.pot; do

      GETTEXT_TRANSLATIONS_LANGUAGE_PO_FILE="$(basename "${GETTEXT_TRANSLATIONS_LANGUAGE_POT_FILE}" .pot).po"
      log "INFO" "  Updating '${GETTEXT_TRANSLATIONS_LANGUAGE_PO_FILE}' from '${GETTEXT_TRANSLATIONS_LANGUAGE_POT_FILE}' ..."
      ...
      _gettext_translations_run_binary msgmerge \
        ...
        --quiet \
        --sort-by-file \
        -U "${GETTEXT_TRANSLATIONS_LANGUAGE_SUB_PATH}/${GETTEXT_TRANSLATIONS_LANGUAGE_PO_FILE}" \
        "${GETTEXT_TRANSLATIONS_LANGUAGE_POT_FILE}"
